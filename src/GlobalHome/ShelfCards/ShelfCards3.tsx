...
import casafundo from "./../../../public/shelfsimgs/casafundo.webp"
    ...
    return (
      <div> 
        <hr className='shelfhr' />         
          <div className='shelfcards shelfalone'> 
          <div id='shelf-slide-alone'>
            <img src={casafundo} alt="" />
            <div className='shelf-txt-slide-alone'>
              <div>
              <h2>As melhores ofertas para mudar de casa sem sair dela.</h2>
